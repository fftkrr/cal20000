...
// ±◊∑π∞Ì∏Æ∑¬ ≥‚ø˘¿œ¿Ã µÈæÓ¿÷¥¬ ≈¬¿Ωø˘¿« Ω√¿€«’ªË¿œ¡ˆ,∏¡¿œΩ√,≥°«’ªË¿œΩ√ IP-±≥¡°»≤∞Ê
...
// ±≥¡°»≤∞Ê∞˙ ¥ﬁ¿« »≤∞Ê∞˙¿« ¬˜¿Ã
// ¿œΩƒ : «’ªË¿œ∂ß ¿Ã ¬˜¿Ã∞° 15.3µµ ¿Ã≥ª¿Ã∏È ¿œΩƒ»ÆΩ«
//                           18.5µµ ¿Ã≥ª¿Ã∏È ¿œΩƒ∞°¥…
// ø˘Ωƒ : ∏¡¿œ∂ß ¿Ã ¬˜¿Ã∞° 9.5µµ ¿Ã≥ª¿Ã∏È ¿œΩƒ»ÆΩ«
//                        12.2µµ ¿Ã≥ª¿Ã∏È ¿œΩƒ∞°¥…
...
{ syear,smonth,sday¿« ¿¸»ƒ «’ªË¿œΩ√,∏¡¿œΩ√ π◊ «’ªË¿œΩ√¿« ±≥¡°»≤∞Ê }
procedure getlunarfirst(const syear:integer;const smonth,sday:smallint;
                        var year:integer;var month,day,hour,min:smallint;var ip:extended;
                        var yearm:integer;var monthm,daym,hourm,minm:smallint;var ipm:extended;
                        var year1:integer;var month1,day1,hour1,min1:smallint;var ip1:extended);
...
begin  { 1996≥‚ ±‚¡ÿ }
{  sl:=day*0.98564736+278.956807; {≈¬æÁ∆Ú±’∞Êµµ  }
{  smin:=282.869498+0.00004708*day; {≈¬æÁ±Ÿ¿œ¡°∞Êµµ}
{  sminangle := Pi*(sl-smin)/180 ; {≈¬æÁ∆Ú±’±Ÿ¡°¿Ã∞¢ - ∂Ûµæ» }
{  sd := 1.919*SIN(sminangle)+0.02*SIN(2*sminangle); { ¡ﬂΩ…¬˜ }
{  result := degreelow(sl + sd) { ≈¬æÁΩ«¡¶∞Êµµ }
// end;
